...
This article is actually a repost of what was originally posted at [Laurent Luce's Blog](https://www.laurentluce.com/posts/python-dictionary-implementation/) August 29, 2011 by Laurent Luce. I mentor several students of Russian [Learn Python](https://learn.python.ru/) courses. They have questions about structures in Python and how to use them. I found this post a good help to me and possibly to my students.
...
![The hash function for strings in Python for a table size of 8](https://www.laurentluce.com/images/blog/dict/hash.png)
...
You can read more about this probing sequence by looking at the source code of [dictobject.c](http://svn.python.org/projects/python/trunk/Objects/dictobject.c). A detailed explanation of the probing mechanism can be found at the top of the file.

![open addressing](https://www.laurentluce.com/images/blog/dict/probing.png)
...
When a new key/value pair is added, PyDict_SetItem() is called. This function takes a pointer to the dictionary object and the key/value pair. It checks if the key is a string and calculates the hash or reuses the one cached if it exists. insertdict() is called to add the new key/value pair and the dictionary is resized if the number of used slots + dummy slots is greater than 2/3 of the array's size. Why 2/3? It is to make sure the probing sequence can find a free slot fast enough. We will look at the resizing function later.
...
![python dictionary insert](https://www.laurentluce.com/images/blog/dict/insert.png)
...
![python dictionary table resizing](https://www.laurentluce.com/images/blog/dict/resizing.png)
...
![Python dictionary delete key](https://www.laurentluce.com/images/blog/dict/delete.png)
